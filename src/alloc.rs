...
const NON_HEAP_STATIC_ALLOC_SPACE: usize = 1 * 1024; // 10 KB
...
const HEAP_SIZE: usize = TOTAL_MEM_SIZE - STACK_TOP_ADDR  - NON_HEAP_STATIC_ALLOC_SPACE - FAST_HEAP_SIZE - LEAF_SIZE; // make the slow heap as big as possible
